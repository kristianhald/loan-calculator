    ...
    public class FlexKContributionRateStairCase
    {
        ...
        private static IEnumerable<ContributionRateStep> Rates()
        {
            return new[]
            {
                ...
                ContributionRateStep.From(LoanToValue.From(0.80m), YearlyContributionRate.From(0.015252m)),
                ContributionRateStep.From(LoanToValue.From(1.0m), YearlyContributionRate.From(0.008564m - 0.000001m))
            };
        }
    }
}