...
{
    public class FlexKContributionRateStairCase
    {
        private FlexKContributionRateStairCase() { }
        ...
        private static IEnumerable<ContributionRateStep> Rates()
        {
            return new[]
            {
                ...
                ContributionRateStep.From(LoanToValue.From(0.60m), YearlyContributionRate.From(0.011000m)),
                ContributionRateStep.From(LoanToValue.From(0.80m), YearlyContributionRate.From(0.018504m)),
                ContributionRateStep.From(LoanToValue.From(1.00m), YearlyContributionRate.From(0.010126m))
            };
        }
    }
}