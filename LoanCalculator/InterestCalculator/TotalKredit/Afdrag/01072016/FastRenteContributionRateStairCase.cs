    ...
    public class FastRenteContributionRateStairCase
    {
        ...
        private static IEnumerable<ContributionRateStep> Rates()
        {
            return new[]
            {
                ...
                ContributionRateStep.From(LoanToValue.From(0.60m), YearlyContributionRate.From(0.008500m)),
                ContributionRateStep.From(LoanToValue.From(0.80m), YearlyContributionRate.From(0.012000m)),
                ContributionRateStep.From(LoanToValue.From(1.00m), YearlyContributionRate.From(0.007375m))
            };
        }
    }
}