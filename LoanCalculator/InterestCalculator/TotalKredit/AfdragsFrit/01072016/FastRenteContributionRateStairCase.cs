    ...
    public class FastRenteContributionRateStairCase
    {
        ...
        private static IEnumerable<ContributionRateStep> Rates()
        {
            return new[]
            {
                ...
                ContributionRateStep.From(LoanToValue.From(0.80m), YearlyContributionRate.From(0.020000m)),
                ContributionRateStep.From(LoanToValue.From(1.00m), YearlyContributionRate.From(0.010625m))
            };
        }
    }
}