...
{
    public class FKortContributionRateStairCase
    {
        private FKortContributionRateStairCase() { }
        ...
        private static IEnumerable<ContributionRateStep> Rates()
        {
            return new[]
            {
                ...
                ContributionRateStep.From(LoanToValue.From(0.80m), YearlyContributionRate.From(0.023500m)),
                ContributionRateStep.From(LoanToValue.From(1.00m), YearlyContributionRate.From(0.01225m))
            };
        }
    }
}