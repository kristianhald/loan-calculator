...
namespace Koolawong.InterestCalculator.BrfKredit.Afdrag
{
    public class KortRenteContributionRateStairCase
    {
        ...
        private static IEnumerable<ContributionRateStep> Rates()
        {
            return new[]
            {
                ContributionRateStep.From(LoanToValue.From(0.40m), YearlyContributionRate.From(0.003750m)),
                ContributionRateStep.From(LoanToValue.From(0.60m), YearlyContributionRate.From(0.009500m)),
                ContributionRateStep.From(LoanToValue.From(0.80m), YearlyContributionRate.From(0.013000m)),
