...
namespace RealkreditDanmarkScraper
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var exchangeList = httpClient.GetStringAsync("http://www.rd.dk/da-dk/privat/koeb-bolig/Kurser-og-renter/Pages/Aktuelle-priser.aspx?segment=P&obl=fl").Result;
            ...
            foreach (var company in allCompanies)
            {
                ...
                if (name.Equals("Realkredit Danmark", StringComparison.OrdinalIgnoreCase))
                    companyId = id;
            }
